...
public class CourseTest {
    ...
    Course course = new Course("testID", "testName", "testDesc", "testCategory", "testTeacher", "testImage", "testRating");
    ...
    public void testGetters() {
        ...
        String expected6 = "testRating";
        assertEquals(expected6, course.getRating());
    }
